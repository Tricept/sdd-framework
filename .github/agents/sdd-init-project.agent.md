...
Configure SDD framework for a new project by gathering requirements and generating project-specific files.
...
- **Spec-Driven Development**: All features start with a specification
...
git init
git add -A
git commit -m "chore: configure SDD framework for project"
```
...
- This command configures SDD for new projects
